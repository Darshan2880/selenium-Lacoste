...
public class stporject {
	...
	//cancel
	//driver.findElement(By.xpath("/html/body/div[3]/aside[5]/div[2]/header/button")).click();
	// add  to cart
	//driver.findElement(By.xpath("//*[@id=\"modal-content-23\"]/div/div[2]/div[2]/button")).click();
		// view to cart
	driver.findElement(By.xpath("/html/body/div[2]/header/div[3]/div[2]/div/div/div/div[2]/div[4]/div/a/span")).click();
	//profile
	driver.findElement(By.xpath("//*[@id=\"html-body\"]/div[2]/header/div[3]/div[6]/div[1]")).click();
	//log out
